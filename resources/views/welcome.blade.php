        ...
        <div class="container position-relative">
            <div class="carousel-item active">
                <div class="container-fluid carousel-container" style="margin-top: 80px;">
                    <h2 class="text-center text-uppercase" style="font-size: 28px;">Welcome to BGG&nbsp;ENTERTAINMENT
                    </h2>
            ...
            <div class="carousel-item">
                <div class="carousel-container" style="margin-top: 80px;">
                    ...
                    <p style="font-weight: bold; color: white;">At BGG ENTERTAINMENT, we believe in the power of
                        creativity to inspire change. Our platform showcases talented individuals in content creation,
                        music, dance, and sports, providing them with the exposure and opportunities they deserve.
            ...
            <div class="carousel-item">
                <div class="carousel-container" style="margin-top: 80px;">
                    ...
                    <p style="color:white; font-weight: bold;">🌍 Our mission extends beyond entertainment—we bridge
                        social and cultural gaps by providing a platform for global black creatives.

                        <br>🎶 Through music, storytelling, and entrepreneurship, we create a space where talent meets
                        opportunity, fostering unity and growth in our community.
...
<div class="container" data-aos="fade-up" data-aos-delay="100" style="padding: 10px;">
    ...
    <div class="swiper-slide position-relative" style="margin-top: -50px;">
        <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
            ...
            <a href="{{ asset('assets/img/gallery/POST-PANDEMIC.mp4') }}"
                class="glightbox pulsating2-play-btn pulsating-play-btn">
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="service-item item-cyan position-relative">
                    ...
                    <p style="color: black;">
                        We provide a platform for creatives in music, dance, sports, and content creation to showcase
                        their gifts and gain global recognition.</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="service-item item-orange position-relative">
                    ...
                    <p style="color: black;">
                        The Labyrinth Scholarship supports talented individuals with tuition assistance—helping them
                        achieve their educational dreams.</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="service-item item-teal position-relative">
                    ...
                    <p style="color: black;">
                        We connect and uplift the global black community through storytelling, entertainment, and
                        entrepreneurship.</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
                <div class="service-item item-red position-relative">
                    ...
                    <p style="color: black;">
                        Our mission is rooted in sharing the message of Jesus Christ while fostering creativity and
                        social impact.</p>
    ...
    <div class="container" style="margin-top: -60px;">
        <div class="row gy-4">
            ...
            <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="200">
                <h3 style="text-align: center; font-size: 20px; color: black;">Empowering Talent, Uplifting Communities,
                    Bridging Cultures</h3>
                ...
                <ul>
                    <li><i class="bi bi-check2-all"></i> <span style="color: black;">Showcase creatives through
                            entertainment events.</span></li>
                    <li><i class="bi bi-check2-all"></i> <span style="color: black;">Provide scholarships to talented
                            individuals</span></li>
                    <li><i class="bi bi-check2-all"></i> <span style="color: black;">Offer mentorship & growth
                            opportunities</span></li>
                    <li><i class="bi bi-check2-all"></i> <span style="color: black;">Support entrepreneurs in the global
                            black community</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="row gy-4">
            <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="bulletin">
                    ...
                    <p style="color: black;">&#8226; Highlight and promote the talents of underrepresented communities.
                    </p>
                ...
                <p style="color: black;">
                    To be a platform where creativity meets purpose, giving voices to untold stories and providing
                    life-changing opportunities for young talents worldwide.
                </p>
                <p style="color:black">We envision a world where creativity, faith, and unity drive meaningful change.
                </p>
            </div>
            <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100"
                style="position: relative; padding-bottom: 35%; height: 0; overflow: hidden;">
                <iframe src="https://www.youtube.com/embed/6nlf1KaaqxI" title="YouTube video player" frameborder="0"
        ...
        <div class="row gy-4" style="margin-top: -40px;">
            <div class="col-lg-4 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay="100">
                <div class="service-item item-cyan position-relative"
                    ...
                    <a href="#" class="stretched-link" style="text-align: center;">
                        <h3 style="color: white; font-size: 17px; text-align: center;">
                            <b>Unlock Your Future with <span style="white-space: nowrap;">BGG ENTERTAINMENT</span></b>
                        </h3>
                    </a>

                    <p style="text-align: justify;">Scholarships will be available starting January 2025! To be
                        eligible, you must be a registered talent and follow us on Instagram, Facebook, YouTube, and
                        TikTok.</p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay="100">
                <div class="service-item item-cyan position-relative"
                    ...
                    <div style="position: relative; display: block; text-align: center;">
                        <a href="{{ asset("assets/img/THE-LABYRINTH-SCHOLARSHIP.pdf") }}" target="_blank"
                            style="text-decoration: none;">
                            <div
                                style="padding: 10px; background-color: #007bff; color: white; display: inline-block; border-radius: 5px; cursor: pointer;">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay="200">
                <div class="service-item item-orange position-relative"
                    style="background-color: black; color:white; text-align: justify; padding: 20px; border-radius: 10px;">
                    <a href="#" class="stretched-link">
                    ...
                    <p style="text-align: center;"><em><b>By God's grace, you could be our next Labyrinth Scholarship
                                Recipient for 2025!</b></em></p>
                </div>
            </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-4">
            ...
            <section style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px; margin-top: -90px;">
                <img src="{{ asset('assets/img/gallery/gallery8_new.jpg') }}" alt="Image 2"
                    style="width: 30%; height: auto; object-fit: cover;">
                <img src="{{ asset('assets/img/gallery/gallery11.jpg') }}" alt="Image 1"
                    style="width: 30%; height: auto; object-fit: cover;">
                <img src="{{ asset('assets/img/gallery/gallery1.jpg') }}" alt="Image 3"
                    style="width: 30%; height: auto; object-fit: cover;">
                <img src="{{ asset('assets/img/gallery/gallery12.jpg') }}" alt="Image 4"
                    style="width: 30%; height: auto; object-fit: cover;">
                <img src="{{ asset('assets/img/gallery/img15.avif') }}" alt="Image 4"
                    style="width: 30%; height: auto; object-fit: cover;">
                <img src="{{ asset('assets/img/gallery/gallery2.jpg') }}" alt="Image 5"
                    style="width: 30%; height: auto; object-fit: cover;">
            </section>
            <div class="swiper-container">
                <div class="swiper-wrapper" style="margin-top: -30px;">
                    ...
                    <div class="swiper-slide"><img src="{{ asset('assets/img/gallery/gallery3.jpg') }}"
                            class="glightbox fixed-size-img"></div>
                    <div class="swiper-slide"><img src="{{ asset('assets/img/gallery/gallery6.jpg') }}"
                            class="glightbox fixed-size-img"></div>
                    <div class="swiper-slide"><img src="{{ asset('assets/img/gallery/img1.jpg') }}"
                            class="glightbox fixed-size-img"></div>
                    <div class="swiper-slide"><img src="{{ asset('assets/img/gallery/img2.jpg') }}"
                            class="glightbox fixed-size-img"></div>
                    <div class="swiper-slide"><img src="{{ asset('assets/img/gallery/img14.avif') }}"
                            class="glightbox fixed-size-img"></div>
                    <div class="swiper-slide"><img src="{{ asset('assets/img/gallery/img3.jpg') }}"
                            class="glightbox fixed-size-img"></div>
                    <div class="swiper-slide"><img src="{{ asset('assets/img/gallery/img4.jpg') }}"
                            class="glightbox fixed-size-img"></div>
                    <div class="swiper-slide"><img src="{{ asset('assets/img/gallery/jeangirl.jpeg') }}"
                            class="glightbox fixed-size-img"></div>
                </div>
